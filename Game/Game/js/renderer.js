...
var Renderer = (function () {
    ...
    Renderer.prototype._initLayer = function () {
        var self = this;
    ...
    // ---- Config Handler ----
    Renderer.prototype._loadConfig = function () {
        this._elements = {};
    ...
    Renderer.prototype._loadMap = function () {
    ...
    Renderer.prototype._updateTile = function (tile) {
    ...
    Renderer.prototype._renderMap = function (callback) {
    ...
    Renderer.prototype._renderDynamic = function () {
        /*
    ...
    // -------------
    Renderer.prototype.test = function (offset) {
    ...
    // --- Draw Functions ----
    Renderer.prototype._clear = function (ctx) {
    ...
    Renderer.prototype._addTile = function (tile, x, y, ignoreOutOfSight, readyCallback) {
    ...
    Renderer.prototype._addImage = function (ctx, src, x, y, width, height, imageOnLoad, ignoreOutOfSight) {
    ...
    // --- Helper Functions ----
    Renderer.prototype._getFile = function (url, callback, dataType) {
    ...
    Renderer.prototype._log = function (message, objects) {
        if (this._config.debug) {
            console.log(message, objects);
        }
    };

    Renderer.prototype._info = function (message, objects) {
        if (this._config.debug) {
            console.info(message, objects);
        }
    };

    Renderer.prototype._warn = function (message, objects) {
        if (this._config.debug) {
            console.warn(message, objects);
        }
    };

    Renderer.prototype._error = function (message, objects) {
        if (this._config.debug) {
